 ...
 * - the GCM auth tag guarantees the stored token was not tampered with.
 *
...
export class TokenEncryptionService {
  ...
  /** Encrypts a plaintext token; output is safe to store in the database. */
  ...
  /** Decrypts a previously encrypted token. Throws when the payload is invalid. */
